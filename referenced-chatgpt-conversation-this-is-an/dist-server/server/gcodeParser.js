import { PLA_DENSITY_G_CM3 } from "../shared/profile.js";
...
export function parseGcode(gcode, settings) {
    ...
    let estimatedSecondsFromComment = null;
    let totalExtrusionSegments = 0;
    let sampled = false;
    let bounds = null;
    const updateBounds = (nx, ny, nz) => {
    ...
    for (const rawLine of lines) {
        ...
        if (/estimated printing time/i.test(commentText)) {
            ...
            if (parsed)
                estimatedSecondsFromComment = parsed;
        }
