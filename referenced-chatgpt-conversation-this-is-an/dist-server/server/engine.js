...
export function detectEngine() {
    ...
    return {
        ...
        version: null,
        searched,
        message: "No slicer engine was found. Install PrusaSlicer or SuperSlicer, then set PRUSASLICER_BIN to the CLI binary path.",
    };
}
export function runEngine(binaryPath, args, timeoutMs = 15 * 60 * 1000) {
